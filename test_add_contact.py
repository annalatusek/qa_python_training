...
class TestAddContact(unittest.TestCase):
    ...
    def go_back_to_the_home_page(self, wd):
    ...
    def test_add_contact(self):
        ...
        self.create_contact(wd, Contact(firstname="Anna", middlename="Zofia", lastname="Latusek", nickname="Ania",
        ...
        self.go_back_to_the_home_page(wd)
        self.logout(wd)
